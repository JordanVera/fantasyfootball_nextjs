    ...
    <>
      <form onSubmit={handleSignIn} className="flex flex-col gap-5">
        ...
        <div className="relative group w-full">
          ...
          <button className="relative px-7 py-4 bg-white dark:bg-black text-primary rounded-xl leading-none flex items-center divide-x divide-gray-600 w-full  justify-center text-xs font-bold">
            Sign in
          </button>
        </div>
      </form>
